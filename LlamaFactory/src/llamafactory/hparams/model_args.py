...
class ModelArguments(
    ...
    data_rank1: int | None = field(
        default=4,
        metadata={"help": "Low-rank dimension used by DATA adapters."},
    )
    data_rank2: int | None = field(
        default=16,
        metadata={"help": "Second low-rank dimension used by DATA adapters."},
    )
