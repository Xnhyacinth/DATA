...
class DataArguments:
    ...
    select: int | None = field(
        default=None,
        metadata={"help": "Select a fixed number of examples per task for debugging or ablation."},
    )
    orders: list[str] = field(
        default_factory=list,
        metadata={"help": "Task order list used by continual learning stage."},
    )
    replay: bool | None = field(
        default=None,
        metadata={"help": "Whether or not to enable rehearsal replay in continual learning."},
    )
